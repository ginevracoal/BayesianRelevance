...
from adversarialAttacks import attack, load_attack, attack_evaluation, attack_increasing_eps, plot_increasing_eps
...
class GPRedBNN:
    ...
    def train(self, x_train, y_train, device):
        ...
        self.gp = gp
        print(osut_train, self.gp.predict(out_train))
...
def main(args):
    ...
    # df = pandas.read_csv(TESTS+nn.savedir+"/"+str(args.dataset)+"_increasing_eps_"+str(args.attack)+"_samp="+str(gp_samples)+".csv")
