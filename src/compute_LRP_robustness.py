...
parser.add_argument("--lrp_method", default="imagewise", type=str, help="intersection, union, average")
...
for samp_idx, n_samples in enumerate(n_samples_list):
	...
	preds, atk_preds, softmax_rob, successf_idxs = attack_evaluation(net=bayesnet, x_test=images, 
...
mode_preds, mode_atk_preds, mode_softmax_robustness, mode_successful_idxs = attack_evaluation(net=bayesnet, x_test=images, 
